...
export const create = async (req, res) => {
  ...
  const member = await prisma.teamMember.create({
    data: {
      ...
      degree,
      degreeHi: degreeHi ?? null,
      experience,
      image,
      bio,
      bioHi: bioHi ?? null,
      expertise,
      expertiseHi: expertiseHi ?? null,
      portfolio,
      portfolioHi: portfolioHi ?? null,
      ...pickSocialUrls({
        facebookUrl,
        twitterUrl,
        linkedinUrl,
...
export const update = async (req, res) => {
  ...
  const member = await prisma.teamMember.update({
    ...
    data: {
      ...
      ...(degreeHi !== undefined && { degreeHi }),
      ...(experience !== undefined && { experience }),
      ...(image !== undefined && { image }),
      ...(bio !== undefined && { bio }),
      ...(bioHi !== undefined && { bioHi }),
      ...(expertise !== undefined && { expertise }),
      ...(expertiseHi !== undefined && { expertiseHi }),
      ...(portfolio !== undefined && { portfolio }),
      ...(portfolioHi !== undefined && { portfolioHi }),
      ...social,
